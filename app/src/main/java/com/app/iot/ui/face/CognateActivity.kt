...
import com.app.iot.databinding.ActivityCognateBinding
...
class CognateActivity : AppCompatActivity() {

        private lateinit var database: DatabaseReference
        private lateinit var binding: ActivityCognateBinding
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            binding = ActivityCognateBinding.inflate(layoutInflater)
        ...
        private fun getMemberData() {
            ...
            var reference: DatabaseReference = FirebaseDatabase.getInstance().getReference().child("cognate")
...
//                        }
                        ...
                        adapter.setOnItemClickListener(object : UserAdapter1.onItemClickListener{
                            override fun onItemClick(position: Int) {
                                ...
                                val mBuilder = AlertDialog.Builder(this@CognateActivity).setView(mDialogView).setTitle("Image")
                                ...
                                mDialogView.deletebutton.setOnClickListener {
                                    ...
                                    Toast.makeText(this@CognateActivity, "Add member successful", Toast.LENGTH_SHORT).show()
                                    mAlertDialog.dismiss()
                                    onBackPressed()
                                }
                                Toast.makeText(this@CognateActivity, "you clicked on item no. $position", Toast.LENGTH_SHORT).show()
                            }
                        })
