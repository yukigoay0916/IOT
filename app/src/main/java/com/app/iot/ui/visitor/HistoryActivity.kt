...
import com.app.iot.databinding.ActivityHistoryBinding
import com.app.iot.databinding.ActivityPopUpWindowBinding
...
class HistoryActivity : AppCompatActivity() {
    ...
    private lateinit var binding2: ActivityPopUpWindowBinding
    private lateinit var firebaseAuth: FirebaseAuth

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityHistoryBinding.inflate(layoutInflater)
        binding2= ActivityPopUpWindowBinding.inflate(layoutInflater)
...
//            }
//        }
        recordRecyclerview = binding.recordList
                        ...
                        adapter.setOnItemClickListener(object : UserAdapter1.onItemClickListener{
                            override fun onItemClick(position: Int) {
                                ...
                                mDialogView.deletebutton.setOnClickListener {
                                    ...
                                    Toast.makeText(this@HistoryActivity, "Add member successful", Toast.LENGTH_SHORT).show()
                                    mAlertDialog.dismiss()
                                    onBackPressed()
                                }
