...
import com.app.iot.databinding.ActivityDeliveryBinding
...
class DeliveryActivity : AppCompatActivity() {
        ...
        private fun getMemberData() {
            ...
            var reference: DatabaseReference = FirebaseDatabase.getInstance().getReference().child("deliveryman")
...
//                        }
                        ...
                        adapter.setOnItemClickListener(object : UserAdapter1.onItemClickListener{
                            override fun onItemClick(position: Int) {
                                ...
                                val mBuilder = AlertDialog.Builder(this@DeliveryActivity).setView(mDialogView).setTitle("Image")
                                ...
                                mDialogView.deletebutton.setOnClickListener {
                                    ...
                                    Toast.makeText(this@DeliveryActivity, "Add member successful", Toast.LENGTH_SHORT).show()
                                    mAlertDialog.dismiss()
                                    onBackPressed()
                                }
                                Toast.makeText(this@DeliveryActivity, "you clicked on item no. $position", Toast.LENGTH_SHORT).show()
                            }
                        })
