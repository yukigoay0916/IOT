...
import com.app.iot.databinding.ActivityNeighbourBinding
...
class NeighbourActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityNeighbourBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityNeighbourBinding.inflate(layoutInflater)
    ...
    private fun getMemberData() {
        ...
        var reference: DatabaseReference = FirebaseDatabase.getInstance().getReference().child("neighbour")
...
//                        }
                    ...
                    adapter.setOnItemClickListener(object : UserAdapter1.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            val mBuilder = AlertDialog.Builder(this@NeighbourActivity).setView(mDialogView).setTitle("Image")
                            ...
                            mDialogView.deletebutton.setOnClickListener {
                                ...
                                Toast.makeText(this@NeighbourActivity, "Add member successful", Toast.LENGTH_SHORT).show()
                                mAlertDialog.dismiss()
                                onBackPressed()
                            }
                            Toast.makeText(this@NeighbourActivity, "you clicked on item no. $position", Toast.LENGTH_SHORT).show()
                        }
                    })
