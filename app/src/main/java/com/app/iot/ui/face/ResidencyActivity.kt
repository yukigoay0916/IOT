...
import com.app.iot.databinding.ActivityResidencyBinding
...
class ResidencyActivity : AppCompatActivity() {

        private lateinit var database: DatabaseReference
        private lateinit var binding: ActivityResidencyBinding
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            binding = ActivityResidencyBinding.inflate(layoutInflater)
        ...
        private fun getMemberData() {
            ...
            var reference: DatabaseReference = FirebaseDatabase.getInstance().getReference().child("residency")
...
//                        }
                        ...
                        adapter.setOnItemClickListener(object : UserAdapter1.onItemClickListener{
                            override fun onItemClick(position: Int) {
                                ...
                                val mBuilder = AlertDialog.Builder(this@ResidencyActivity).setView(mDialogView).setTitle("Image")
                                ...
                                mDialogView.deletebutton.setOnClickListener {
                                    ...
                                    Toast.makeText(this@ResidencyActivity, "Add member successful", Toast.LENGTH_SHORT).show()
                                    mAlertDialog.dismiss()
                                    onBackPressed()
                                }
                                Toast.makeText(this@ResidencyActivity, "you clicked on item no. $position", Toast.LENGTH_SHORT).show()
                            }
                        })
