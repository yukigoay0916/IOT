...
import com.app.iot.ui.report.ReportActivity
import com.app.iot.ui.report.listAdded
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button3.setOnClickListener{
            if(admin) {
                startActivity(Intent(applicationContext, KnownPerson::class.java))
                finish()
            }
            else{
        ...
        binding.rpBtn.setOnClickListener {
